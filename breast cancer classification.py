...
data["target"] = [1 if i.strip() == "M" else 0 
...
plt.scatter(test_data.iloc[diff,0], test_data.iloc[diff,1], label = "Wrong Cllassified", alpha = 0.2, color = "red", s = 1000)
